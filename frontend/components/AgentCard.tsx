...
export function AgentCard({ agent, spotlightTier, totalTips }: AgentCardProps) {
  ...
  return (
    <>
      <div
        className={`bg-agx-surface border rounded-xl p-5 hover:border-agx-accent/30 transition-colors ${
          agent.promoted ? "border-agx-gold/40" : "border-agx-border"
        }`}
      >
        {/* Spotlight badge */}
        {spotlightTier && (
